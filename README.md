...
Steps
We will first build a model using sklearn and linear regression using  home prices dataset from kaggle.com.
...
Dataset Reference House price data
I have also uploaed the csv file in this repository Data.csv
